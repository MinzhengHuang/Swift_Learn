...
struct Location{
    ...
    init(coordinateString: String){
        ...
        let commaPos = coordinateString.range(of: ",")
        let firstElement = coordinateString.substring(to: (commaPos?.lowerBound)!)
        let secondElement = coordinateString.substring(from: (commaPos?.upperBound)!)
